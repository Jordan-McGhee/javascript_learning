...
calculateSleepDebt = () => {
    ...
    if (actualSleepHours === idealSleepHours) {
        console.log(`You got the perfect amount of sleep with ${actualSleepHours} hours of sleep this week!`)
    } else if (actualSleepHours > idealSleepHours) {
        console.log(`You got more sleep than you needed with ${actualSleepHours} hours of sleep this week!`)
    } else {
        console.log(`You didn't get the amount of sleep you needed with ${actualSleepHours} hours of sleep this week. Get some rest!`)
    }
}
